...
<div class="order">
  <div class="left">
    <form method="post" action="" class="form" name="form1" onsubmit="return check(this)">
      <dl>
     ...
     <br>
          ...
          <div id="content-item2" style="display: none;">
            <dd class="pro" style=" height: 50px;">
              ...
              <span class="prolist">
     <label><input type="radio" name="pid" value="3" price="128" datatype="pid">
微信公众号（订阅号）
     </label>
     <label><input type="radio" name="pid" value="9" price="399" datatype="pid">
小程序名称抢注（赠送推广名片小程序）
     </label>
<label><input type="radio" name="pid" value="4" price="500" datatype="pid">
微站小程序（个人版）
